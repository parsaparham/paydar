...
$sql = "update orders set customer_id='$customer_id',device='$device',serial='$serial',problem='$problem',description='$description',status_id='$status_id',service_fee_announcement='$service_fee_announcement',battery_replacement='$battery_replacement',input_cable='$input_cable',exit_tahvil_girandeh_id='$tahvil_girandeh_id' where id=?";
$arr=array($did);
