...
require_once('libsms/nusoap.php');
	...
	/////////////////// Web Service Address ////////////////////////
    ////// آدرس وب سرویس /////////////////////////////////
/*$client = new nusoap_client('http://panel.payamakpardaz.ir/smssendwebservice.asmx?wsdl', 'wsdl',
						'', '', '', '');*/

$client = new nusoap_client('http://panel.raysan.ir/smsSendWebService.asmx');
...
if ($client->fault) {
	...
	if ($err) {
        ...
        echo "<h1>".$result["getCreditResult"]."</h1>";
		echo '</pre>';
	}
}
