                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a href="order_change_status_edit1.php?id=<?php echo $id; ?>"><span class="accordion-item badge-danger"><?php echo $status_name ?></span></a></td>
                                        ...
                                        <td style="text-align: center"><a href="order_edit1.php?id=<?php echo $id; ?>"> <span class="accordion-item badge-primary">ویرایش</span></a></td>
                                    </tr>
                                        <?php
                                        }
                                        ?>
