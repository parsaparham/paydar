                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li class="open active conditional-bg">
                            ...
                            <ul>
                                ...
                                <li>
                                <a href="order_exit1.php" class="">
                                    <i class="icon-home"></i>
                                    <span> خروج دستگاه</span>
                                </a>
                                 </li>
                                <li>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-6">
                <div class="stat-box bg-red shadow">
                    <a href="order_exit1.php">
                        <div class="stat">
                            <!--<div class="counter-down" data-value="512"></div>-->
                            <br/>
                            <div class="h3">خروج دستگاه</div>
                        </div><!-- /.stat -->
                        <div class="visual">
                            <i class="icon-wallet"></i>
                        </div><!-- /.visual -->
...
-->                        </div><!-- /.stat -->
            ...
            <?php
            $sql="select * from orders where status_id=3 and exit_device=0 order by id desc";
