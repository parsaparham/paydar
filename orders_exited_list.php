                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="data-table">
                                    ...
                                    foreach ($res4 as $row4){
                                        ...
                                        $EntryCode=$row4['EntryCode'];
                                        $agent_report=$row4['agent_report'];


                                    $sql5="select * from users where id=?";
                                    $arr5=array($customer_id);
                                    $row5=$object->select($sql5,$arr5);
                                    if(isset($row5[0]['name'])){ $customer=$row5[0]['name'];}
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="order_edit1.php?id=<?php echo $id; ?>"> <?php echo $customer ?></a></td>
                                            <td><?php echo $device;  ?></td>
                                            <td><?php echo $serial;  ?></td>
                                            <td><?php echo $bill_number;  ?></td>
                                            <td><?php echo $agent_report;  ?></td>
