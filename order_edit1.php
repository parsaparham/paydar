...
/*                            if(isset($no_output)){$no_output="checked";}else{$no_output="";}
                            ...
                            <div class="portlet-body">
                                <form method="post" role="form" action="order_edit2.php"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="portlet-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="customer">
                                                    <option><?php echo $customer_name ?></option>
                                                    <?php
                                                    $sql="select * from users where per_id!=3 order by id desc ";
                                                    $res=$object->select($sql,$customer_id);
                                                    foreach ($res as $row){
                                                        $name=$row['name'];
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea name="device" class="form-control" rows="2" ><?php echo $device ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input name="serial" class="form-control" value="<?php echo $serial ?> " >
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="no_output"   type="checkbox" <?php echo $no_output ?>  >
                                                    <?php echo $no_output ?>
                                                    خروجی ندارد
                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="connection"  type="checkbox" <?php echo $connection ?>  >
                                                    <?php echo $connection ?>
                                                    اتصالی دارد
                                                </label>
                                            </div>
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="fuse"   type="checkbox" <?php echo $fuse ?>  >
                                                    فیوز ورودی را قطع می کند
                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="burning" type="checkbox" <?php echo $burning ?> >
                                                     بوی سوختگی می دهد
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="battery"  type="checkbox" <?php echo $battery ?>  >
                                                    باتری خراب است
                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="charger"  type="checkbox" <?php echo $charger ?>  >
                                                    شارژر خراب است
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="inverter"   type="checkbox" <?php echo $inverter ?> >
                                                    اینورتر خراب است
                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="rectifier"  type="checkbox" <?php echo $rectifier ?>   >
                                                    رکتیفایر خراب است
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="volt_high"   type="checkbox" <?php echo $volt_high ?> >
                                                    ولتاژ خروجی بالا است
                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="volt_low"  type="checkbox" <?php echo $volt_low ?>  >
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="fan"  type="checkbox" <?php echo $fan ?>  >
                                                    فن خراب است
                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="hot"  type="checkbox" <?php echo $hot ?>  >
                                                    دستگاه داغ میکند
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea name="problem" class="form-control" rows="3" ><?php echo $problem?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="warranty" value="enable" type="radio" <?php if($warranty==1){echo "checked";}else{echo "";}?> >
گارانتی دارد                                                </label>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>
                                                    <input name="warranty" value="disable" type="radio" <?php if($warranty==0){echo"checked";}else{echo "";}?> >
                                                    گارانتی ندارد
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="input-group">
                                        <div class="col-sm-6">
                                        <label>
                                            <input name="service_fee_announcement" value="enable" type="radio" <?php if($service_fee_announcement==1){echo "checked";}else{echo "";}?> >
                                            اعلام هزینه شود
                                        </label>
                                        </div>
                                        <div class="col-sm-6">
                                        <label>
                                            <input name="service_fee_announcement" value="disable" type="radio" <?php if($service_fee_announcement==0){echo"checked";}else{echo "";}?> >
                                            اعلام هزینه نشود
                                        </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <div class="col-sm-6">
                                        <label>
                                            <input name="battery_replacement" value="enable"  type="radio" <?php if($battery_replacement==1){echo "checked";}?> >
                                            تعویض باتری انجام گردد
                                        </label>
                                        </div>
                                        <div class="col-sm-6">
                                        <label>
                                            <input name="battery_replacement" value="disable"  type="radio" <?php if($battery_replacement==0){echo "checked";}?> >
                                    ...
                                    <div class="input-group">
                                        <div class="col-sm-6">
                                        <label>
                                            <input name="input_cable" value="enable"   type="radio" <?php if($input_cable==1){echo "checked";} ?> >
                                            کابل ورودی دارد
                                        </label>
                                        </div>
                                        <div class="col-sm-6">
                                        <label>
                                            <input name="input_cable"  value="disable"  type="radio" <?php if($input_cable==0){echo "checked";} ?> >
                                            کابل ورودی ندارد
                                        </label>
                                        </div>
                                    </div>
                                    ...
                                    <hr/>
                                        ...
                                        <div class="portlet-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="tahvil_girandeh">
                                                    <option><?php echo $tahvil_girandeh_name?></option>

                                                    <?php
                                                    $sql="select * from users where per_id=3 and id!='$tahvil_girandeh_id' ";
                                        ...
                                        <div class="form-group row">
                                            <label>  کد ورود</label>
                                            <div class="col-sm-12">
                                                <input name="EntryCode" class="form-control" value="<?php echo $EntryCode ?> " >
                                            </div>
                                        </div>
