                        ...
                        <div class="portlet-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" id="data-table">
                                    ...
                                    <?php
                                    $sql4="select * from orders ORDER BY id desc";
                                    ...
                                    <tr>
                                        <td><?php echo var_dump($id); ?></td>
                                        <td><?php echo $date . str_repeat('&nbsp;', 2); ?></td>
                                        <td><?php echo $time; ?></td>
                                        <td><?php echo $ticket_number; ?></td>
                                        <td><?php echo $customer; ?></td>
                                        <td><?php echo $agent; ?></td>
<!--                                        <td><img width="25" height="25" src="<?php /*echo $service_fee_announcement */?>">
-->                                        </td>
                                        <td style="text-align: center"><a
                                                    href="order_change_status_edit1.php?id=<?php echo $id; ?>"><span
                                                        class="accordion-item badge-danger"><?php $status_name ?></span></a>
                                        </td>
                                        <td style="text-align: center"><a
                                                    href="order_view_more.php?id=<?php echo $id; ?>"> <span
                                                        class="accordion-item badge-primary">جزيیات</span></a>
                                        </td>
                                        <?php
                                        }
                                        ?>
